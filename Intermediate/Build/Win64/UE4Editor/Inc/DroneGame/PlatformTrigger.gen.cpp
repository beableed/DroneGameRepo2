...
// Cross Module References
	DRONEGAME_API UClass* Z_Construct_UClass_APlatformTrigger_NoRegister();
	DRONEGAME_API UClass* Z_Construct_UClass_APlatformTrigger();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_DroneGame();
	DRONEGAME_API UFunction* Z_Construct_UFunction_APlatformTrigger_OnOverlapBegin();
	ENGINE_API UScriptStruct* Z_Construct_UScriptStruct_FHitResult();
	ENGINE_API UClass* Z_Construct_UClass_UPrimitiveComponent_NoRegister();
	ENGINE_API UClass* Z_Construct_UClass_AActor_NoRegister();
	DRONEGAME_API UFunction* Z_Construct_UFunction_APlatformTrigger_OnOverlapEnd();
	DRONEGAME_API UClass* Z_Construct_UClass_AMovingPlatform_NoRegister();
...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_APlatformTrigger()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_APlatformTrigger_OnOverlapBegin, "OnOverlapBegin" }, // 528823650
				{ &Z_Construct_UFunction_APlatformTrigger_OnOverlapEnd, "OnOverlapEnd" }, // 2567590903
			};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(APlatformTrigger, 3166490683);
	static FCompiledInDefer Z_CompiledInDefer_UClass_APlatformTrigger(Z_Construct_UClass_APlatformTrigger, &APlatformTrigger::StaticClass, TEXT("/Script/DroneGame"), TEXT("APlatformTrigger"), false, nullptr, nullptr, nullptr);
